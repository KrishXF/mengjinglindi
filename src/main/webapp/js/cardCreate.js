(function setCards() {
    var cardInfo = document.getElementById("cardJson").value = "" +
        "{" +
        "  \"card\": {" +
        "      \"card_type\": \"GROUPON\"," +
        "      \"GROUPON\": {" +
        ...
        "              \"center_url\": \"http://demo.steam-steam.cn\"," +
        "              \"abstract\": \"abstract\"," +
        "          }," +
        "      }," +
        "\"deal_detail\": \"aaaaa \""  +
    ...
    var localInfo = document.getElementById("localJson").value = "{\"Introduc\":\"Introduc\",\"Name\":\"测试用自领取券test\",\"Price\":10000,\"Type\":1,\"Inventory\":10,\"Remarks\":\"Remarks\",\"StartDate\":\"2018-7-27\",\"EndDate\":\"2019-8-31\",\"TimeRemarks\":\"TimeRemarks\"}"
})();
