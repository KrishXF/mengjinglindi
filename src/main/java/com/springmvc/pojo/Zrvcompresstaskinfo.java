...
public class Zrvcompresstaskinfo {
    ...
    private Integer webserviceupdatestatus;
    ...
    public Integer getWebserviceupdatestatus() {
        return webserviceupdatestatus;
    }

    public void setWebserviceupdatestatus(Integer webserviceupdatestatus) {
        this.webserviceupdatestatus = webserviceupdatestatus;
    }
